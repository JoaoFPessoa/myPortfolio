export const portuguese = {
  bannerTitle: "Desenvolvedor frontend.",
  bannerSubtitle:
    "Especializado em criar interfaces de usuário incríveis e funcionais.",
  introTitle: "Olá, sou o João. Bem-vindo ao meu website!",
  introSubtitle:
